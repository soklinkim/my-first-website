...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success('Registration successful! Welcome to DropLink!');
        navigate('/dashboard');
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-purple-600">DropLink</h2>
          <p className="mt-2 text-sm text-gray-600">Cambodia's Marketplace</p>
        </div>
